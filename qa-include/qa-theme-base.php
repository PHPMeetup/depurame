...
class qa_html_theme_base {
    ...
    function bs_footer()
    {
        ...
        $this->output('<footer class="footer">
            ...
            <p><a href="https://github.com/dvidsilva/q2a-bootstrap">Q2A-Bootstrap Framework</a> developed by <a href="https://github.com/dvidsilva">Harsh J. Vakharia</a></p>
            <ul class="footer-links">
            <li><a href="../">Home</a></li>
            <li><a href="../feedback">Feedback</a></li>
            <li><a href="http://twitter.com/dvidsilva">Twitter</a></li>
            </ul>
            </div>
            </footer>');
    ...
    function navbar_bs_brand()
    {
        ...
        $this->output('<a class="brand" href="https://github.com/dvidsilva/q2a-bootstrap">Q2A-BS</a>');
    ...
    function header()
    {
            ...
            $this->output('<div class="jumbotron masthead">
                            ...
                            <li><a href="../" >Home</a></li>
                            <li>Developed by <a href="https://github.com/dvidsilva">Harsh J. Vakharia</a></li>
                            </ul>
                            </div>
            </div>');*/
    ...
    function below_navbar()
    {
        ...
        $this->output('<div class="bs-docs-social">
            ...
            <li>
            <iframe src="http://ghbtns.com/github-btn.html?user=dvidsilva&repo=q2a-bootstrap&type=watch" allowtransparency="true" frameborder="0" scrolling="0" width="62px" height="20px"></iframe>
            </li>
            <li>
            <iframe src="http://ghbtns.com/github-btn.html?user=dvidsilva&repo=q2a-bootstrap&type=fork" allowtransparency="true" frameborder="0" scrolling="0" width="53px" height="20px"></iframe>
            </li>
            <li class="follow-btn">
            <a href="https://twitter.com/dvidsilva" class="twitter-follow-button" data-show-count="false">Follow @dvidsilva</a>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
</li>
<li class="tweet-btn">
<a href="https://twitter.com/share" class="twitter-share-button" data-url="https://github.com/dvidsilva" data-text="Sweet and Clean Twitter Bootstrap Theme for Question2Answer.org Developed by Harsh Vakharia" data-via="dvidsilva" data-count="none">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
</li>
</ul>
</div>
