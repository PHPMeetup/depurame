...
*/
	...
	define('QA_MYSQL_USERNAME', 'depurame');
	define('QA_MYSQL_PASSWORD', 'wDj6RhqRbWluOor');
	define('QA_MYSQL_DATABASE', 'depurame');
...
/*
	...
	define('QA_WORDPRESS_INTEGRATE_PATH', '/var/www/latamhacks.com/web
');
*/
/*
